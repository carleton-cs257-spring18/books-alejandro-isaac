...
class AuthorList:
    ...
    def get_author_from_book_id(self, book_id, book_author_link_list):
        author_list = []
    ...
    def get_author_from_search_text(self, search_text):
        author_list = []
    ...
    def get_author_from_start_year(self, start_year):
        author_list = []
        for indexed_author in self.author_list:
    ...
    def get_author_from_end_year(self, end_year):
        author_list = []
        for indexed_author in self.author_list:
    ...
    def filter_author_list(self, author_list, filter_list):
        target_list = []
        for author in author_list:
            if author in filter_list:
                target_list.append(author)
        return target_list
