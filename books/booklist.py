...
class BookList:
    ...
    def get_book_from_author_id(self, author_id, book_author_link_list):
        book_list = []
    ...
    def get_book_from_search_text(self, search_text):
        book_list = []
    ...
    def get_book_from_start_year(self, start_year):
        book_list = []
        for indexed_book in self.book_list:
    ...
    def get_book_from_end_year(self, end_year):
        book_list = []
        for indexed_book in self.book_list:
            if indexed_book.get_publication_year() <= end_year:
                book_list.append(indexed_book.get_book())
        return book_list

    def filter_book_list(self, book_list, filter_list):
        target_list = []
        for book in book_list:
            if book in filter_list:
